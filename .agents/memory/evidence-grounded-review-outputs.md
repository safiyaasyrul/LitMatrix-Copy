...
**How to apply:** Derive counts from stored records and explicit decisions. Use “not reported” for absent fields. Default heterogeneous evidence to narrative synthesis and require explicit comparable effect data before quantitative pooling.