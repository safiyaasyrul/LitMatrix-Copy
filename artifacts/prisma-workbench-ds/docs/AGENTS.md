# PRISMA 2020 Workbench Design System design system
...
workspace package (`@workspace/prisma-workbench-ds`): other artifacts depend
...
`@workspace/prisma-workbench-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/prisma-workbench-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/prisma-workbench-ds` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/prisma-workbench-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/prisma-workbench-ds/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/prisma-workbench-ds/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/prisma-workbench-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/prisma-workbench-ds/docs/migrating-expo.md`
