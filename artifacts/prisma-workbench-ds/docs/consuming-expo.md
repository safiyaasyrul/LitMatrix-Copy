# Consuming PRISMA 2020 Workbench Design System in Expo apps

Read `artifacts/prisma-workbench-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/prisma-workbench-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/prisma-workbench-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/prisma-workbench-ds/lib/native-theme";
import { useColors } from "@workspace/prisma-workbench-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/prisma-workbench-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/prisma-workbench-ds/components/native/badge";
import { Button } from "@workspace/prisma-workbench-ds/components/native/button";
import { Card } from "@workspace/prisma-workbench-ds/components/native/card";
```
...
Import and render
`@workspace/prisma-workbench-ds/components/native/button`, then run Expo
