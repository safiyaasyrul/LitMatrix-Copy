# Migrating web UI to PRISMA 2020 Workbench Design System

Read `artifacts/prisma-workbench-ds/docs/AGENTS.md` and
`artifacts/prisma-workbench-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/prisma-workbench-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/prisma-workbench-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/prisma-workbench-ds/hooks/use-toast`
